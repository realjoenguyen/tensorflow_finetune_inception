...
def add_evaluation_step(result_tensor, ground_truth_tensor):
	...
	with tf.name_scope('evaluation'):
		...
		with tf.name_scope('accuracy'):
			...
			# evaluation_step, _ = tf.metrics.precision(true_labels, prediction)
...
def main(_):
	...
	with tf.Session(graph=graph) as sess:
		...
		from sklearn.metrics import accuracy_score, classification_report, recall_score, accuracy_score
		print (classification_report(true_labels, predictions))
		print (accuracy_score(true_labels, predictions, average='macro'))
